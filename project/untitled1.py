# -*- coding: utf-8 -*-
"""
Created on Fri May  6 00:02:17 2022
...
file = mpimg.imread('D:/Desktop/Uni/project/corrected/hmi.ic_45s.20220206_000000_TAI.2.continuum.fits.png')
...
ax.set_axis_off()
fig.add_axes(ax)
plt.imshow(file, cmap = 'Greys_r',origin='lower')
...
# cbar.locator = matplotlib.ticker.FixedLocator([0, 60*1e3])
# cbar.set_label("AR2939 05/02/2022 13:42", labelpad=-40, rotation=0)
# cbar.update_ticks()
